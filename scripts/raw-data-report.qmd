...
```{r}
#| echo: false
tar_load(neighbourhood_response_facet)
neighbourhood_response_facet
```

```{r}
#| echo: false
tar_load(neighbourhood_response_pca)
...
```{r}
#| echo: false
tar_load(neighbourhood_tree_pca)
...
```{r}
#| echo: false
tar_load(neighbourhood_built_pca)
neighbourhood_built_pca
```
...
```{r}
#| echo: false
tar_load(neighbourhood_census_pca)
