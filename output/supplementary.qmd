...
Figure S4a. Partial dependency plot for carbon monoxide model at the city scale. 

![](../graphics/cities_NO2_pdp.png)

Figure S4b. Partial dependency plot for nitrogen dioxide model at the city scale.


![](../graphics/cities_O3_pdp.png)

Figure S4c. Partial dependency plot for ozone model at the city scale.

![](../graphics/cities_UV_pdp.png)

Figure S4d. Partial dependency plot for UV aerosols model at the city scale.


![](../graphics/neighbourhoods_CO_pdp.png)

Figure S4e. Partial dependency plot for carbon monoxide model at the neighbourhood scale. 

![](../graphics/neighbourhoods_NO2_pdp.png)

Figure S4f. Partial dependency plot for nitrogen dioxide model at the neighbourhood scale.


![](../graphics/neighbourhoods_O3_pdp.png)

Figure S4g. Partial dependency plot for ozone model at the neighbourhood scale.

![](../graphics/neighbourhoods_UV_pdp.png)

Figure S4h. Partial dependency plot for UV aerosols model at the neighbourhood scale.
