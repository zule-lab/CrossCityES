...
read.csv('graphics/cities_temp_model-metrics.csv') %>% 
  knitr::kable()
...
read.csv('graphics/neighbourhoods_temp_model-metrics.csv') %>% 
  knitr::kable()
```
...
read.csv('graphics/streets_temp_model-metrics.csv') %>% 
  knitr::kable()
...
read.csv('graphics/cities_UV_model-metrics.csv') %>% 
  knitr::kable()
```
...
read.csv('graphics/neighbourhoods_UV_model-metrics.csv') %>% 
  knitr::kable()
```
...
read.csv('graphics/cities_CO_model-metrics.csv') %>% 
  knitr::kable()
```
...
read.csv('graphics/neighbourhoods_CO_model-metrics.csv') %>% 
  knitr::kable()
```
...
read.csv('graphics/cities_SO2_model-metrics.csv') %>% 
  knitr::kable()
```
...
read.csv('graphics/neighbourhoods_SO2_model-metrics.csv') %>% 
  knitr::kable()
```
...
#| 
read.csv('graphics/cities_NO2_model-metrics.csv') %>% 
  knitr::kable()
```
...
read.csv('graphics/neighbourhoods_NO2_model-metrics.csv') %>% 
  knitr::kable()
```
...
read.csv('graphics/cities_O3_model-metrics.csv') %>% 
  knitr::kable()
```
...
#| 
read.csv('graphics/neighbourhoods_O3_model-metrics.csv') %>% 
  knitr::kable()
```
