...
values_ee <- tribble(
  ...
  'large/dem/streets_bldhgt.csv', 'Data/Landsat_Temperature/streets_bldhgt.csv',
  ...
  'large/pollution/cities_NO2.csv', 'Data/SENTINEL_Pollution/NO2_city.csv',
  'large/pollution/neighbourhoods_NO2.csv', 'Data/SENTINEL_Pollution/NO2_hood.csv',
  'large/pollution/cities_O3.csv', 'Data/SENTINEL_Pollution/O3_city.csv',
  'large/pollution/neighbourhoods_O3.csv', 'Data/SENTINEL_Pollution/O3_hood.csv',
  'large/pollution/cities_SO2.csv', 'Data/SENTINEL_Pollution/SO2_city.csv',
  'large/pollution/neighbourhoods_SO2.csv', 'Data/SENTINEL_Pollution/SO2_hood.csv',
  'large/pollution/cities_UV.csv', 'Data/SENTINEL_Pollution/UV_city.csv',
  'large/pollution/neighbourhoods_UV.csv', 'Data/SENTINEL_Pollution/UV_hood.csv'
